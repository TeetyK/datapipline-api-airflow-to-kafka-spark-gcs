...
class TestApiNinjasClient:
    ...
    def test_fetch_success_with_valid_response(
        self, mock_get, sample_api_response, assert_user_schema
    ):
...
class TestKafkaProducer:
    ...
    def test_produce_to_kafka_success(
        self, mock_producer_class, sample_api_response, mock_kafka_producer
    ):
    ...
    @patch('dags.api.KafkaProducer')
    def test_produce_partial_failure(
        self, mock_producer_class, sample_api_response, mock_kafka_producer
    ):
