...
def fetch_api_data(**context):
    api_url = os.getenv("API_URL", "https://api.api-ninjas.com/v2/randomuser?count=5")
...
with DAG(
    ...
    validate_delivery = PythonOperator(
        task_id="validate_kafka_delivery", python_callable=validate_kafka_delivery, trigger_rule="all_done"
    )
